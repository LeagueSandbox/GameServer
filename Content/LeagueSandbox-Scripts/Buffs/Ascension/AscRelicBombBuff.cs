...
namespace Buffs
{
    internal class AscRelicBombBuff : IBuffGameScript
    {
        ...
        public void OnActivate(IAttackableUnit unit, IBuff buff, ISpell ownerSpell)
        {
            ...
            AddParticleTarget(unit, unit, "Asc_RelicPrism_Sand", unit, 25000.0f, direction: new Vector3(0.0f, 0.0f, -1.0f), flags: (FXFlags)304);
            AddParticleTarget(unit, unit, "Asc_relic_Sand_buf", unit, 25000.0f, flags: (FXFlags)32);
