...
namespace MapScripts.Map11
{
    public class NeutralMinionSpawn
    {
        ...
        {
            //Blue Side Blue Buff
            var blue_blueBuff = CreateJungleCamp(new Vector3(3871.4885f, 60.0f, 7901.054f), 1, TeamId.TEAM_BLUE, "Camp", 113.9f * 1000, spawnDuration: 1.1f);
            ...
            //Blue Side Wraiths
            var blueWraiths = CreateJungleCamp(new Vector3(6706.678f, 60.0f, 5521.044f), 3, TeamId.TEAM_BLUE, "LesserCamp", 114.0f * 1000, spawnDuration: 1.0f);
            ...
            //Blue Side RedBuff
            var blue_RedBuff = CreateJungleCamp(new Vector3(7862.2437f, 60.0f, 4111.1865f), 4, TeamId.TEAM_BLUE, "Camp", 113.34f * 1000, spawnDuration: 1.66f);
            ...
            //Blue Side Golems
            var blueGolems = CreateJungleCamp(new Vector3(8323.471f, 60.0f, 2754.9475f), 5, TeamId.TEAM_BLUE, "LesserCamp", 114.14f * 1000, spawnDuration: 0.86f);
            ...
            //Dragon
            var dragon = CreateJungleCamp(new Vector3(9866.148f, 60.0f, 4414.014f), 6, 0, "Dragon", 143.5f * 1000, revealEvent: 43, spawnDuration: 6.5f);
            ...
            //Red Side BlueBuff
            var red_BlueBuff = CreateJungleCamp(new Vector3(10931.729f, 60.0f, 6990.844f), 7, TeamId.TEAM_PURPLE, "Camp", 113.9f * 1000, spawnDuration: 1.1f);
            ...
            //Red side Wolfs
            var redWolves = CreateJungleCamp(new Vector3(11008.152f, 60.0f, 8387.408f), 8, TeamId.TEAM_PURPLE, "LesserCamp", 114.34f * 1000, spawnDuration: 0.66f);
            ...
            //Red Side Wraiths
            var redWraiths = CreateJungleCamp(new Vector3(7986.9966f, 60.0f, 9471.389f), 9, TeamId.TEAM_PURPLE, "LesserCamp", 114.33f * 1000, spawnDuration: 0.67f);
            ...
            //Red Side RedBuff
            var red_RedBuff = CreateJungleCamp(new Vector3(7016.869f, 60.0f, 10775.547f), 10, TeamId.TEAM_PURPLE, "Camp", 113.34f * 1000, spawnDuration: 1.66f);
            ...
            //Red Side Krugs
            var redGolems = CreateJungleCamp(new Vector3(6317.0923f, 60.0f, 12146.458f), 11, TeamId.TEAM_PURPLE, "LesserCamp", 114.14f * 1000, spawnDuration: 0.86f);
            ...
            //Baron
            var baron = CreateJungleCamp(new Vector3(5007.1235f, 60.0f, 10471.446f), 12, 0, "Baron", 1191.5f * 1000, revealEvent: 42, spawnDuration: 8.5f);
            ...
            //Blue Side Gromp
            var blueGreatGromp = CreateJungleCamp(new Vector3(2090.6284f, 60.0f, 8427.984f), 13, 0, "LesserCamp", 111.8f * 1000, spawnDuration: 3.2f);
            ...
            //Red Side Gromp
            var redGreatGromp = CreateJungleCamp(new Vector3(12703.629f, 60.0f, 6443.984f), 14, 0, "LesserCamp", 111.8f * 1000, spawnDuration: 3.2f);
