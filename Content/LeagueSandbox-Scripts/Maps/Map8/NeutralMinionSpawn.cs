...
namespace MapScripts.Map8
{
    public class NeutralMinionSpawn
    {
        ...
        public static void InitializeJungle(IMapScriptHandler map)
        {
            ...
            {
                var point = map.CreateMinion("OdinNeutralGuardian", "OdinNeutralGuardian", new Vector2(map.InfoPoints[i].CentralPoint.X, map.InfoPoints[i].CentralPoint.Z), ignoreCollision: true);
