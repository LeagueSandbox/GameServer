namespace LeagueSandbox.GameServer.Logic.Packets.PacketHandlers
{
    public enum PacketCmd : short
    {
        ...
        PKT_S2C_QUEST = 0x8C,
        PKT_C2S_EXIT = 0x8F,
        PKT_C2S_WORLD_SENDGame_NUMBER = 0x92, // <-- At least one of these is probably wrong
        PKT_S2C_WORLD_SENDGame_NUMBER = 0x92, // <--
        ...
        PKT_S2CGame_TIMER = 0xC1,
        PKT_S2CGame_TIMER_UPDATE = 0xC2,
        PKT_S2C_CHAR_STATS = 0xC4,
        PKT_S2CGame_END = 0xC6,
