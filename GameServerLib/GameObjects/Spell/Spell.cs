...
namespace LeagueSandbox.GameServer.GameObjects.Spell
{
    public class Spell : ISpell
    {
        ...
        public bool Cast(Vector2 start, Vector2 end, IAttackableUnit unit = null)
        {
            ...
            if (_game.Config.GameFeatures.ManaCostsEnabled)
            {
        ...
        {
            return _game.Config.GameFeatures.CooldownsEnabled ? SpellData.Cooldown[CastInfo.SpellLevel] * (1 - CastInfo.Owner.Stats.CooldownReduction.Total) : 0;
        }
