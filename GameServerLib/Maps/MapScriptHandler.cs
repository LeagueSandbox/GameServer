...
namespace LeagueSandbox.GameServer.Maps
{
    ...
    public class MapScriptHandler : IMapScriptHandler
    {
        ...
        public void Init()
        {
            Dictionary<GameObjectTypes, List<IMapObject>> mapObjects = new Dictionary<GameObjectTypes, List<IMapObject>>();
            foreach (var mapObject in MapData.MapObjects.Values)
            {
                ...
                {
                    mapObjects.Add(objectType, new List<IMapObject>());
                }
            ...
            {
                mapObjects.Add(GameObjectTypes.ObjBuildingBarracks, new List<IMapObject>());
