...
namespace GameServerCore.Maps
{
    ...
    public interface IMapScriptHandler : IUpdate
    {
        ...
        /// </summary>
        /// <param name="loosingTeam">The team who lost the game</param>
        ...
        void EndGame(TeamId loosingTeam, Vector3 finalCameraPosition, float endGameTimer = 5000.0f, bool moveCamera = true, float cameraTimer = 3.0f, bool disableUI = true, IDeathData deathData = null);
    }
}
