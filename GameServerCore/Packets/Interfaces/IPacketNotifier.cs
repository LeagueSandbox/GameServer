...
namespace GameServerCore.Packets.Interfaces
{
    public interface IPacketNotifier
    {
        ...
        void NotifyDamageDone(IAttackableUnit source, IAttackableUnit target, Damage damage, DamageText damagetext, bool isGlobal = true, int sourceId = 0, int targetId = 0);
